...
book.add_page(ChapterPage.new("Chapter: The Experiments"))
...
book.add_page(ChapterPage.new("Chapter: The Answers"))
...
book.add_page(ChapterPage.new("Chapter: The Rules"))
book.add_page(IllustrationPage.new("cat.5","Cat destroys the desk."))
