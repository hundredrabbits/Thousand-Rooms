...
book.add_page(ChapterPage.new(             {:en => "The Rules",                                   :fr => "Les Regles",                                      :ru => "Правила",                                     :jp => "ルール"}))
...
book.add_page(IllustrationPage.new("bat.1",{:en => "Bat finds a pen.",                            :fr => "La chauve-souris trouve un crayon.",              :ru => "Бат находит ручку. ",                         :jp => "バットはペンを見つける。"}))
...
book.add_page(ChapterPage.new(             {:en => "The Questions",                               :fr => "Les Questions",                                   :ru => "Эксперименты ",                               :jp => "実験"}))
...
book.add_page(ChapterPage.new(             {:en => "The Answers",                                 :fr => "Les Reponses",                                    :ru => "Ответы",                                      :jp => "回答"}))
...
book.add_page(ChapterPage.new(             {:en => "The Experiments",                             :fr => "Les Experiences",                                 :ru => "Правила",                                     :jp => "ルール"}))
...
book.add_page(ChapterPage.new(             {:en => "The Results",                                 :fr => "Les Resultats",                                   :ru => "Правила",                                     :jp => "ルール"}))
...
book.add_page(ChapterPage.new(             {:en => "The End",                                     :fr => "",                                                :ru => "Правила",                                     :jp => "ルール"}))
