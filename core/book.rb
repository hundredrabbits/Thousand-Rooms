...
class Book
  ...
  page { page-break-after: always; border:1px solid black; display:block; padding:10px; width:300px; height:400px; position:relative; margin-bottom:30px; border-radius:3px}
